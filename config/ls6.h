...
Preset presets[] = {
    { "LukeROTJ", "tracks/jabba.wav",
        ...
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Green,Black,200,500>,Blinking<Green,Black,50,500>>>,300,800,Blinking<Green, Black, 2000, 500>>>(),
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Black,Red,200,500>,Blinking<Black,Red,50,500>>>,300,800,Blinking<Black, Red, 2000, 500>>>(), "LukeROTJ"},
    { "R1Vader", "tracks/hall.wav",
        ...
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Green,Black,200,500>,Blinking<Green,Black,50,500>>>,300,800,Blinking<Green, Black, 2000, 500>>>(),
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Black,Red,200,500>,Blinking<Black,Red,50,500>>>,300,800,Blinking<Black, Red, 2000, 500>>>(), "R1Vader"},
    { "Graflex8", "tracks/rey_training.wav",
        ...
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Green,Black,200,500>,Blinking<Green,Black,50,500>>>,300,800,Blinking<Green, Black, 2000, 500>>>(),
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Black,Red,200,500>,Blinking<Black,Red,50,500>>>,300,800,Blinking<Black, Red, 2000, 500>>>(), "Graflex8"},
    { "Kguard", "tracks/kylotlj.wav",
        ...
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Green,Black,200,500>,Blinking<Green,Black,50,500>>>,300,800,Blinking<Green, Black, 2000, 500>>>(),
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Black,Red,200,500>,Blinking<Black,Red,50,500>>>,300,800,Blinking<Black, Red, 2000, 500>>>(), "Kguard"},
    { "balance", "tracks/venus.wav",
        ...
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Green,Black,200,500>,Blinking<Green,Black,50,500>>>,300,800,Blinking<Green, Black, 2000, 500>>>(),
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Black,Red,200,500>,Blinking<Black,Red,50,500>>>,300,800,Blinking<Black, Red, 2000, 500>>>(), "balance"},
    { "Traya", "tracks/mars.wav",
        ...
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Green,Black,200,500>,Blinking<Green,Black,50,500>>>,300,800,Blinking<Green, Black, 2000, 500>>>(),
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Black,Red,200,500>,Blinking<Black,Red,50,500>>>,300,800,Blinking<Black, Red, 2000, 500>>>(), "Traya"},
    { "Light", "tracks/rots.wav",
        ...
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Green,Black,200,500>,Blinking<Green,Black,50,500>>>,300,800,Blinking<Green, Black, 2000, 500>>>(),
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Black,Red,200,500>,Blinking<Black,Red,50,500>>>,300,800,Blinking<Black, Red, 2000, 500>>>(), "Light"},
    { "DrkKyber", "tracks/mars.wav",
        ...
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Green,Black,200,500>,Blinking<Green,Black,50,500>>>,300,800,Blinking<Green, Black, 2000, 500>>>(),
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Black,Red,200,500>,Blinking<Black,Red,50,500>>>,300,800,Blinking<Black, Red, 2000, 500>>>(), "DrkKyber"},
    { "vengence", "tracks/mercury.wav",
        ...
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Green,Black,200,500>,Blinking<Green,Black,50,500>>>,300,800,Blinking<Green, Black, 2000, 500>>>(),
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Black,Red,200,500>,Blinking<Black,Red,50,500>>>,300,800,Blinking<Black, Red, 2000, 500>>>(), "vengence"},
    { "RgueCmdr", "tracks/venus.wav",
        ...
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Green,Black,200,500>,Blinking<Green,Black,50,500>>>,300,800,Blinking<Green, Black, 2000, 500>>>(),
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Black,Red,200,500>,Blinking<Black,Red,50,500>>>,300,800,Blinking<Black, Red, 2000, 500>>>(), "RgueCmdr"},
    { "SAVANT", "tracks/mars.wav",
        StylePtr<InOutHelper<EasyBlade<OnSpark<BrownNoiseFlicker<GREEN, Blue, 50>>, WHITE>, 300, 800> >(),
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Green,Black,200,500>,Blinking<Green,Black,50,500>>>,300,800,Blinking<Green, Black, 2000, 500>>>(),
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Black,Red,200,500>,Blinking<Black,Red,50,500>>>,300,800,Blinking<Black, Red, 2000, 500>>>(), "SAVANT"},
    { "SmthGrey", "tracks/mercury.wav",
        StylePtr<InOutHelper<EasyBlade<OnSpark<Strobe<BLACK, Gradient<Magenta, Red>, 30, 1>>, WHITE>, 300, 800> >(),
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Green,Black,200,500>,Blinking<Green,Black,50,500>>>,300,800,Blinking<Green, Black, 2000, 500>>>(),
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Black,Red,200,500>,Blinking<Black,Red,50,500>>>,300,800,Blinking<Black, Red, 2000, 500>>>(), "SmthGrey"},
    {"SmthJedi", "tracks/uranus.wav",
        StylePtr<InOutHelper<EasyBlade<OnSpark<BrownNoiseFlicker<Yellow, Orange, 50>>, WHITE>, 300, 800> >(),
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Green,Black,200,500>,Blinking<Green,Black,50,500>>>,300,800,Blinking<Green, Black, 2000, 500>>>(),
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Black,Red,200,500>,Blinking<Black,Red,50,500>>>,300,800,Blinking<Black, Red, 2000, 500>>>(), "SmthJedi"},
    { "TeensySF", "tracks/venus.wav",
        ...
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Green,Black,200,500>,Blinking<Green,Black,50,500>>>,300,800,Blinking<Green, Black, 2000, 500>>>(),
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Black,Red,200,500>,Blinking<Black,Red,50,500>>>,300,800,Blinking<Black, Red, 2000, 500>>>(), "TeensySF"},
    { "TthCrstl", "tracks/mars.wav",
        StylePtr<InOutHelper<EasyBlade<OnSpark<RandomPerLEDFlicker<Green, Cyan>>, WHITE>, 300, 800> >(),
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Green,Black,200,500>,Blinking<Green,Black,50,500>>>,300,800,Blinking<Green, Black, 2000, 500>>>(),
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Black,Red,200,500>,Blinking<Black,Red,50,500>>>,300,800,Blinking<Black, Red, 2000, 500>>>(), "TthCrstl"},
    { "SmthFuzz", "tracks/rots.wav",
        StylePtr<InOutSparkTip<EasyBlade<AudioFlicker<HumpFlicker<Green, Blue, 50>, Red>, WHITE>, 300, 800>>(),
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Green,Black,200,500>,Blinking<Green,Black,50,500>>>,300,800,Blinking<Green, Black, 2000, 500>>>(),
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Black,Red,200,500>,Blinking<Black,Red,50,500>>>,300,800,Blinking<Black, Red, 2000, 500>>>(), "SmthFuzz"},
    { "SmthJedi", "tracks/mars.wav",
        &style_charging,
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Green,Black,200,500>,Blinking<Green,Black,50,500>>>,300,800,Blinking<Green, Black, 2000, 500>>>(),
        StylePtr<InOutHelper<SimpleClash<Lockup<Blinking<Black,Red,200,500>,Blinking<Black,Red,50,500>>>,300,800,Blinking<Black, Red, 2000, 500>>>(), "Battery\nLevel"}
};
BladeConfig blades[] = {
