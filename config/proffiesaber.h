...
Preset presets[] = {
   { "BEspin", "tracks/venus.wav",
        StylePtr<InOutHelper<OnSpark<Stab<LocalizedClash<Lockup<Blast<Gradient<AudioFlicker<Rgb<255,75,75>,Tomato>,AudioFlicker<Red,Tomato>,AudioFlicker<Red,Tomato>,AudioFlicker<Red,Tomato>,AudioFlicker<Red,Tomato>,AudioFlicker<Red,Tomato>,AudioFlicker<Red,Tomato>,AudioFlicker<Red,Tomato>,AudioFlicker<Red,Tomato>,AudioFlicker<Red,Tomato>>,BrownNoiseFlicker<Green,Yellow,300>,150,200,600>,Pulsing<Gradient<AudioFlicker<Rgb<255,75,75>,Tomato>,HumpFlicker<Red,Tomato,50>,HumpFlicker<Red,Tomato,50>,HumpFlicker<Red,Tomato,50>,BrownNoiseFlicker<White,Strobe<Blue,LemonChiffon,50,1>,300>,BrownNoiseFlicker<White,Strobe<Blue,LemonChiffon,50,1>,300>,HumpFlicker<Red,Tomato,50>,HumpFlicker<Red,Tomato,50>,HumpFlicker<Red,Tomato,50>,HumpFlicker<Red,Tomato,50>>,Gradient<AudioFlicker<Rgb<255,75,75>,Tomato>,HumpFlicker<Red,Tomato,50>,HumpFlicker<Red,Tomato,50>,HumpFlicker<Red,Tomato,50>,HumpFlicker<Red,Tomato,50>,BrownNoiseFlicker<White,Strobe<Blue,LemonChiffon,50,1>,300>,BrownNoiseFlicker<White,Strobe<Blue,LemonChiffon,50,1>,300>,HumpFlicker<Red,Tomato,50>,HumpFlicker<Red,Tomato,50>,HumpFlicker<Red,Tomato,50>>,3500>,Gradient<AudioFlicker<Red,Tomato>,AudioFlicker<Red,Tomato>,AudioFlicker<Red,Tomato>,Gradient<AudioFlicker<Red,Tomato>,BrownNoiseFlicker<White,Strobe<Blue,LemonChiffon,50,1>,300>,White>>>,BrownNoiseFlicker<White,Strobe<Blue,LemonChiffon,50,1>,50>,100>,Gradient<AudioFlicker<Red,Tomato>,AudioFlicker<Red,Tomato>,AudioFlicker<Red,Tomato>,Gradient<AudioFlicker<Red,Tomato>,BrownNoiseFlicker<White,Strobe<Blue,LemonChiffon,50,1>,300>,White>>,500>,White,200>,200,300>>(), "bank3"},
